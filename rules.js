...
function begin_play(){
	...
	if(game_started() == true){
		...
		alert("You must fill out a player name for both players.")
	}
	else{
...
/*
TODO - Rule 3
This is the last method you'll implement. This method is called everytime a move has been made( Play button was clicked).
The method should do all the things as stated in rule 2.
